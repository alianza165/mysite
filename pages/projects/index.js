  ...
  return (
    ...
    <Breadcrumb crumb={{ lastQueryPart }} />
        ...
        {projects.map((project) => (
          <div className=''>
            <Link key={project.id} href={`/projects/${project.link}`} passHref>
