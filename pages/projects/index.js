...
export default function Projects() {
  ...
  return (
    <div className="overflow-hidden bg-white pt-6 md:pt-10 mb-20">
        ...
        {projects.map((project) => (
          ...
          <div className='hover:drop-shadow-2xl hover:scale-105 transition-all'>
            <Link key={project.id} href={{ pathname: '/projects/detail', query: { name: project.link} }} passHref>
              <div className="shadow aspect-h-1 aspect-w-1 overflow-hidden rounded-lg bg-[url('https://ducaqjqbmh7lv.cloudfront.net/mysite/blur1.jpeg')] xl:aspect-h-8 xl:aspect-w-7">
                <Image
                  src={project.image}
                  width={300} height={200}
                  className="object-contain object-center group-hover:opacity-75 p-2 md:p-3"
                />
              </div>
            </Link>
            </div>
